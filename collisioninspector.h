...
public:
    ...
    bool isPlayerOnFlyingBrick(Player* player, FlyingBrick* flyingBrick) const; // 返回玩家是否处于飞行砖块上
    void dealWithPlayerCollision(Player* player); // 处理玩家有关的碰撞
    void dealWithActiveTrap(Player* player); // 处理主动陷阱出现的问题
